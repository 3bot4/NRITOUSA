...
Processing times for EAD/AP vary — check egov.uscis.gov/processing-times. Filing together with I-485 is the most efficient approach. See also: [USCIS processing times guide](/tools/processing-times)`,
  },
