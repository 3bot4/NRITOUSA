      ...
      <section className="border-b border-ink-900/5 bg-amber-50/40">
        <Container className="py-3">
          <p className="text-center text-xs text-ink-600">
            <strong className="font-semibold text-ink-800">Educational only</strong> — not legal or immigration advice. Always verify at{" "}
            <a href="https://www.uscis.gov/check-processing-times" target="_blank" rel="noopener noreferrer" className="font-semibold underline">
