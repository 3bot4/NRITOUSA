...
const content = getToolHubContent("form-15ca-15cb-checklist")!;
...
export default function Form15ChecklistPage() {
  ...
  return (
    <>
      ...
      {/* Full SEO hub content: what result means, forms explainer, process,
          documents, mistakes, related links (FAQ kept below) */}
