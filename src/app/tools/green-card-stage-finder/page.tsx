...
export default function GreenCardStageFinderPage() {
  ...
  return (
    <>
      ...
      <ToolFirstLayout
        toolSlug="green-card-stage-finder"
        breadcrumb={[
          { label: "Home", href: "/" },
        ...
        category={tool.group}
        title={tool.title}
        hook="Where are you in the green card process? Answer a few questions to see your stage, what's next, and the main bottleneck."
        accent={tool.accent}
        headerExtra={
        ...
        disclaimerExtra={
          <p>
            This tool gives an educational stage assessment only. Priority date
            availability depends on the current official visa bulletin — check{" "}
            <a
