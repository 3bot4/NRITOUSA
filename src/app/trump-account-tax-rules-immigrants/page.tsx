  ...
  return (
    <>
      ...
      >
        ...
        <section className="py-10 sm:py-12">
          <Container>
            <OfficialSourceBox title="Official IRS and Treasury sources" intro="Verify current tax rules directly with the official sources:" links={trumpAccountSourceLinks} />
          </Container>
        </section>
