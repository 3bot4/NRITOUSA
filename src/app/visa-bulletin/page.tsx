    ...
    <>
      ...
      <div className="mx-auto max-w-[720px] px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-10">
          ...
          <div className="rounded-2xl border border-amber-200 bg-amber-50/60 p-5">
            ...
            <ul className="space-y-1.5 text-sm text-amber-800">
              ...
              <li>• India EB-2 is Unavailable in the September 2026 bulletin (no numbers for the rest of FY 2026); new applicants face multi-decade waits when numbers return</li>
        ...
        <section className="mb-10">
          ...
          <p className="text-sm text-ink-600 mb-4">
            EB-5 splits into the <strong>Unreserved</strong> category and three reserved <strong>set-asides</strong> (Rural, High Unemployment, Infrastructure). For September 2026, EB-5 India Unreserved is <strong>Unavailable</strong>, but the set-aside categories remain <strong>Current</strong> — one reason set-aside investments draw India-born investors.
          </p>
          <Eb5SetAsidePanel />
        </section>
