...
const faq: FaqItem[] = [
  ...
  },
  {
    ...
    answer: `No — not as things stand. That concern comes from DHS's fixed-admission rule, which would have required an extension of stay where training ran past a dated admission period. A federal court postponed that rule's effective date nationwide on September 14, 2026, the day before it was due to start, so it never took effect: you are admitted for duration of status and no Form I-539 extension of stay is required for your training period on account of that rule. Its transition provisions, including the March 18, 2027 filing window that would have avoided a separate I-539, only ever mattered if the rule operated — there is no transition to be inside. Because the rule was postponed rather than struck down, this could change; confirm your own position with your DSO.`,
  },
  {
    question: "Is the F-1 grace period still 60 days?",
    answer: `Yes — ${optRules.gracePeriodDays} days, and that is what this calculator uses. A DHS final rule published July 17, 2026 (91 Fed. Reg. 44976) would have replaced duration of status with a fixed admission period and a ${optRules.gracePeriodDaysUnderFixedAdmission}-day grace period from September 15, 2026, but a federal court postponed its effective date nationwide on September 14, 2026 under the Administrative Procedure Act, so it never took effect. The ${optRules.gracePeriodDaysUnderFixedAdmission}-day figure therefore applies to nobody today. The rule was postponed rather than vacated and the litigation continues, so check the admission period on your most recent I-94 and confirm with your DSO rather than assuming the position is settled.`,
  },
  {
