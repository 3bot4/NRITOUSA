...
export const dsFixedAdmissionRule: PolicyItem = {
  ...
  // Re-verified 2026-09-15 against the court order itself. Deliberately an
  // item-level date rather than bumping STUDENT_DATA_VERIFIED, which covers
  // fees and caps that were NOT re-checked today.
