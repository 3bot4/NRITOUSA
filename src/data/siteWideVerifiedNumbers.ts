...
export const permNumbers: NumberGroup = {
  pwd: {
    ...
    note: "FLAG is processing both OEWS and non-OEWS PWD requests received May 2026.",
  },
  recruitment: {
  ...
  analystReview: {
    ...
    sourceName: "DOL FLAG Processing Times",
    sourceUrl: officialSources.dolFlagProcessing,
    note: "DOL's published average is 336 days and analyst review is on November 2025 receipts; audits add 6–12+ months on top.",
  },
  totalNoAudit: {
