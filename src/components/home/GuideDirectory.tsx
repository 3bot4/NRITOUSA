...
const groups: Group[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Renew Your Green Card Online", href: "/green-card-renewal#renew-online" },
      { label: "Replace a Lost or Stolen Green Card", href: "/replace-green-card" },
      { label: "Expired Green Card: Work & Travel", href: "/green-card-renewal#expired-green-card" },
